...
if ( ! function_exists( 'pierogi_bobowskie_theme_support' ) ) :
	/**
	 * Add theme supports
	 */
	function pierogi_bobowskie_theme_support() {
	...
	add_action( 'after_setup_theme', 'pierogi_bobowskie_theme_support' );
endif;
