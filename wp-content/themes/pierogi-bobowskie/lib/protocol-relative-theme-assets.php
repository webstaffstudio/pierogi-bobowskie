...
if ( ! class_exists( 'pierogi_bobowskie_Protocol_Relative_Theme_Assets' ) ) :

	/**
	 * pierogi_bobowskie_Protocol_Relative_Theme_Assets class
	 */
	class pierogi_bobowskie_Protocol_Relative_Theme_Assets {
		/**
	...
	$pierogi_bobowskie_protocol_relative_theme_assets = new pierogi_bobowskie_Protocol_Relative_Theme_Assets();
endif;
